...
class AttendanceDetails extends REST_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('ApiModel/AttendanceDetailsModel');
    }
    public function index_post()
    {
        ...
        try {
            ...
            if($verifiedToken){
                $attendance = new AttendanceDetailsModel;
                    $attendance_detail = $attendance->get_attendance_detail($empId,$date);
                    $resp = array('attendance_info' => $attendance_detail);
