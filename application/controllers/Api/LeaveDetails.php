...
class LeaveDetails extends REST_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('ApiModel/LeaveDetailsModel');
    }
        ...
        try {
            ...
            if($verifiedToken){
                $leave = new LeaveDetailsModel;
                    $leave_detail = $leave->get_leave_detail($leaveId);
                    $resp = array('leave_info' => $leave_detail);
