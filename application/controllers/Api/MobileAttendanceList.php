...
class MobileAttendanceList extends REST_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('ApiModel/MobileAttendanceListModel');
    }
        ...
        try {
            ...
            if($verifiedToken){
                if(empty($items) && empty($customFilters['filterType'])){
                    $attendance = new MobileAttendanceListModel;
                    ...
                    $resp = array('pagesize'=>$pageSize,'page'=>$page,'attendance_rows'=>$attendance_rows,'total_rows'=>$total_rows,'inif'=>'in if');
