...
class MonthlySummary extends REST_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('ApiModel/MonthlySummaryModel');
    }
        ...
        try {
            ...
            if($verifiedToken){
                if(empty($items) && empty($customFilters['filterType'])){
                    ...
                    $total_rows = $summary->count_rows($table,$designation,$emp_id);
                    $attendance_rows = $summary->get_rows($limit, $start, $table,$designation,$emp_id);
                    $resp = array('pagesize'=>$pageSize,'page'=>$page,'summary_rows'=>$attendance_rows,'total_rows'=>$total_rows,'filters'=>$items,'inif'=>'in if');
                    $this->response($resp, 200);
                }
                elseif(empty($items[0]->value) && empty($customFilters['filterType'])){
                    $summary = new MonthlySummaryModel;
                    $total_rows = $summary->count_rows($table,$designation,$emp_id);
                    $summary_rows = $summary->get_rows($limit, $start, $table,$designation,$emp_id);
                ...
                elseif(!empty($customFilters['filterType']) && empty($items[0]->value)){
                    $summary = new MonthlySummaryModel;
                    $total_rows = $summary->custom_filter_rows_count($table,$designation,$emp_id,$customFilters);
                    $summary_rows = $summary->custom_filter_rows($limit, $start, $table,$designation,$emp_id,$customFilters);
                ...
                elseif(!empty($items[0]->value) && empty($customFilters['filterType'])){
                    ...
                    $summary = new MonthlySummaryModel;
                    $total_rows = $summary->mui_filter_rows_count($search, $col, $table, $operator,$designation,$emp_id);
                    $summary_rows = $summary->mui_filter_rows($limit, $start, $search, $col, $operator, $table,$designation,$emp_id);
                    ...
                    $search = $items[0]->value;
                    $summary = new MonthlySummaryModel;
                    $total_rows = $summary->dual_filter_rows_count($search, $col, $table, $operator,$designation,$emp_id,$customFilters);
                    $summary_rows = $summary->dual_filter_rows($limit, $start, $search, $col, $operator, $table,$designation,$emp_id,$customFilters);
