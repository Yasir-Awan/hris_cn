...
class ScheduleDetails extends REST_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('ApiModel/ScheduleDetailsModel');
    }
    public function index_post()
    {
        ...
        try {
            ...
            if($verifiedToken){
                $schedule = new ScheduleDetailsModel;
                    $schedule_detail = $schedule->get_schedule_detail($scheduleId);
                    $resp = array('schedule_info' => $schedule_detail);
