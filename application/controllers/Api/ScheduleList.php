        ...
        try {
            ...
            if($verifiedToken){
                if(empty($items)){
                    ...
                    $total_rows = $schedule->count_records($table,$role,$emp_id);
                    $schedule_rows = $schedule->schedule_records($limit, $start, $table,$role,$emp_id);
                ...
                elseif(empty($items[0]->value)){
                    ...
                    $schedule = new ScheduleListModel;
                    $total_rows = $schedule->filter_rows_count($search, $col, $table, $operator,$role,$emp_id);
                    $schedule_rows = $schedule->filter_rows_search($limit, $start, $search, $col, $operator, $table,$role,$emp_id);
