...
class SummaryDetails extends REST_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('ApiModel/SummaryDetailsModel');
    }
    public function index_post()
    {
        $scheduleId = $this->post('summaryId');
        // $date = $this->post('date');
        ...
        try {
            ...
            if($verifiedToken){
                $attendance = new SummaryDetailsModel;
                    $attendance_detail = $attendance->get_summary_detail($scheduleId);
                    $resp = array('summary_details' => $attendance_detail);
