...
class UpdateLeave extends REST_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('ApiModel/UpdateLeaveModel');
        ...
        try {
            ...
            if($verifiedToken){
                ...
                // Start portion to update the tbl_leaves
                    ...
                    $UpdateLeave = new UpdateLeaveModel;
                    $leaveInfo = $UpdateLeave->UpdateLeave($leaveStart,$leaveEnd,$bio_id,$leave_id,$leave_type,$leave_reason,$addDateTime,$saturdays,$sundays,$totalLeaveDays,$shortHrs);
                    // End portion to update the tbl_leaves
                        $resp = array('msg'=>'leave updated','status'=>'200');
