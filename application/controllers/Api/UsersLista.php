        ...
        try {
            ...
            if($verifiedToken){
                $user = new UsersListModel;
                    ...
                    if(empty($items)){
                        $user = new UsersListModel;
                        $total_rows = $user->count_rows($table,$designation,$emp_id);
                        $employees_rows = $user->get_rows($limit, $start, $table,$designation,$emp_id);
                    ...
                    elseif(empty($items[0]->value)){
                        ...
                        $user = new UsersListModel;
                        $total_rows = $user->count_filtered_rows($search, $col, $table, $operator,$designation,$emp_id);
                        $employees_rows = $user->get_filtered_rows($limit, $start, $search, $col, $operator, $table,$designation,$emp_id);
